...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900">➕ Nuevo Tenant</h1>
    <p class="text-gray-500">Crear un nuevo estudio de abogados en el SaaS</p>
</div>

<form method="POST" action="{{ route('admin.tenants.store') }}" class="bg-white rounded-lg shadow p-6 space-y-4 max-w-xl">
    @csrf
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700">RUC (opcional)</label>
